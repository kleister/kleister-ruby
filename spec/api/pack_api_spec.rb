...
describe 'PackApi' do
  ...
  # @param build_version_params The build version data to attach
  ...
  # unit tests for attach_pack_to_team
  # Attach a team to pack
  # @param pack_id A pack identifier or slug
  # @param pack_team_params The team data to attach
  # @param [Hash] opts the optional parameters
  # @return [Notification]
  describe 'attach_pack_to_team test' do
    it 'should work' do
      # assertion here. ref: https://rspec.info/features/3-12/rspec-expectations/built-in-matchers/
    end
  end
  ...
  # @param pack_id A pack identifier or slug
  # @param pack_user_params The user data to attach
  # @param [Hash] opts the optional parameters
  # @return [Notification]
  ...
  # @param pack_id A pack identifier or slug
  # @param build_id A build identifier or slug
  # @param build_version_params The build version data to unlink
  # @param [Hash] opts the optional parameters
  # @return [Notification]
  ...
  # @param pack_id A pack identifier or slug
  # @param pack_team_params The pack team data to unlink
  # @param [Hash] opts the optional parameters
  # @return [Notification]
  ...
  # @param pack_id A pack identifier or slug
  # @param pack_user_params The pack user data to unlink
  # @param [Hash] opts the optional parameters
  # @return [Notification]
  ...
  # @param pack_id A pack identifier or slug
  # @param pack_team_params The team data to update
  # @param [Hash] opts the optional parameters
  # @return [Notification]
  ...
  # @param pack_id A pack identifier or slug
  # @param pack_user_params The user data to update
  # @param [Hash] opts the optional parameters
  # @return [Notification]
