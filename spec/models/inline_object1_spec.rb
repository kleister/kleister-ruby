...
# Unit tests for Kleister::InlineObject1
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Kleister::InlineObject1 do
  let(:instance) { Kleister::InlineObject1.new }

  describe 'test an instance of InlineObject1' do
    it 'should create an instance of InlineObject1' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Kleister::InlineObject1)
    end
  end
