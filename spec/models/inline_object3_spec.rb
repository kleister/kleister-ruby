...
# Unit tests for Kleister::InlineObject3
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe Kleister::InlineObject3 do
  let(:instance) { Kleister::InlineObject3.new }

  describe 'test an instance of InlineObject3' do
    it 'should create an instance of InlineObject3' do
      # uncomment below to test the instance creation
      # expect(instance).to be_instance_of(Kleister::InlineObject3)
    end
  end
