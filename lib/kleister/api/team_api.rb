...
module Kleister
  class TeamApi
    ...
    def append_team_to_mod_with_http_info(team_id, team_mod, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(team_mod)
      ...
      new_options = opts.merge(
        :operation => :"TeamApi.append_team_to_mod",
    ...
    def append_team_to_pack_with_http_info(team_id, team_pack, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(team_pack)
      ...
      new_options = opts.merge(
        :operation => :"TeamApi.append_team_to_pack",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def append_team_to_user_with_http_info(team_id, team_user, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(team_user)
      ...
      new_options = opts.merge(
        :operation => :"TeamApi.append_team_to_user",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_team_mods_with_http_info(team_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<TeamMod>'
    ...
    def list_team_users_with_http_info(team_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<TeamUser>'
