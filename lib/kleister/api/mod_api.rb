...
module Kleister
  class ModApi
    ...
    def append_mod_to_team_with_http_info(mod_id, mod_team, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(mod_team)
      ...
      new_options = opts.merge(
        :operation => :"ModApi.append_mod_to_team",
    ...
    def append_mod_to_user_with_http_info(mod_id, mod_user, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(mod_user)
      ...
      new_options = opts.merge(
        :operation => :"ModApi.append_mod_to_user",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def append_version_to_build_with_http_info(mod_id, version_id, version_build, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(version_build)
      ...
      new_options = opts.merge(
        :operation => :"ModApi.append_version_to_build",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_mods_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<Mod>'
    ...
    def list_versions_with_http_info(mod_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<Version>'
