...
module Kleister
  class MinecraftApi
    ...
    # @param minecraft_build_params [MinecraftBuildParams] The build data to attach
    # @param [Hash] opts the optional parameters
    # @return [Notification]
    def attach_minecraft_to_build(minecraft_id, minecraft_build_params, opts = {})
      data, _status_code, _headers = attach_minecraft_to_build_with_http_info(minecraft_id, minecraft_build_params, opts)
      data
    end
    ...
    def attach_minecraft_to_build_with_http_info(minecraft_id, minecraft_build_params, opts = {})
      ...
      # verify the required parameter 'minecraft_build_params' is set
      if @api_client.config.client_side_validation && minecraft_build_params.nil?
        raise ArgumentError, "Missing the required parameter 'minecraft_build_params' when calling MinecraftApi.attach_minecraft_to_build"
      end
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(minecraft_build_params)
    ...
    # @param minecraft_id [String] A minecraft identifier or slug
    # @param minecraft_build_params [MinecraftBuildParams] The build data to unlink
    # @param [Hash] opts the optional parameters
    # @return [Notification]
    def delete_minecraft_from_build(minecraft_id, minecraft_build_params, opts = {})
      data, _status_code, _headers = delete_minecraft_from_build_with_http_info(minecraft_id, minecraft_build_params, opts)
      data
    end
    ...
    # @param [Hash] opts the optional parameters
    # @return [Array<(Notification, Integer, Hash)>] Notification data, response status code and response headers
    def delete_minecraft_from_build_with_http_info(minecraft_id, minecraft_build_params, opts = {})
      if @api_client.config.debugging
      ...
      # verify the required parameter 'minecraft_build_params' is set
      if @api_client.config.client_side_validation && minecraft_build_params.nil?
        raise ArgumentError, "Missing the required parameter 'minecraft_build_params' when calling MinecraftApi.delete_minecraft_from_build"
      end
    ...
    # @option opts [Integer] :limit Paging limit (default to 100)
    # @option opts [Integer] :offset Paging offset (default to 0)
    # @return [Array<(MinecraftBuilds, Integer, Hash)>] MinecraftBuilds data, response status code and response headers
    def list_minecraft_builds_with_http_info(minecraft_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'MinecraftBuilds'
    ...
    # @param [Hash] opts the optional parameters
    # @option opts [String] :search Search query
    # @return [Array<(Minecrafts, Integer, Hash)>] Minecrafts data, response status code and response headers
    def list_minecrafts_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Minecrafts'
