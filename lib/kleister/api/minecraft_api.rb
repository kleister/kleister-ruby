...
module Kleister
  class MinecraftApi
    ...
    def append_minecraft_to_build_with_http_info(minecraft_id, minecraft_build, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(minecraft_build)
      ...
      new_options = opts.merge(
        :operation => :"MinecraftApi.append_minecraft_to_build",
    ...
    def list_minecrafts_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<Minecraft>'
    ...
    def search_minecrafts_with_http_info(minecraft_id, opts = {})
      ...
      # resource path
      local_var_path = '/minecraft/{minecraft_id}'.sub('{' + 'minecraft_id' + '}', CGI.escape(minecraft_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"MinecraftApi.search_minecrafts",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
