...
module Kleister
  class GroupApi
    ...
    # @option opts [Integer] :limit Paging limit (default to 100)
    # @option opts [Integer] :offset Paging offset (default to 0)
    # @return [Array<(InlineObject23, Integer, Hash)>] InlineObject23 data, response status code and response headers
    def list_group_mods_with_http_info(group_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InlineObject23'
    ...
    # @option opts [Integer] :limit Paging limit (default to 100)
    # @option opts [Integer] :offset Paging offset (default to 0)
    # @return [Array<(InlineObject24, Integer, Hash)>] InlineObject24 data, response status code and response headers
    def list_group_packs_with_http_info(group_id, opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'InlineObject24'
