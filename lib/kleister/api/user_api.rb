...
module Kleister
  class UserApi
    ...
    def append_user_to_mod_with_http_info(user_id, user_mod, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(user_mod)
      ...
      new_options = opts.merge(
        :operation => :"UserApi.append_user_to_mod",
      ...
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserApi#append_user_to_mod\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
    ...
    def append_user_to_pack_with_http_info(user_id, user_pack, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(user_pack)
      ...
      new_options = opts.merge(
        :operation => :"UserApi.append_user_to_pack",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
      ...
      data, status_code, headers = @api_client.call_api(:POST, local_var_path, new_options)
      if @api_client.config.debugging
        @api_client.config.logger.debug "API called: UserApi#append_user_to_pack\nData: #{data.inspect}\nStatus code: #{status_code}\nHeaders: #{headers}"
      end
      return data, status_code, headers
    end
    ...
    def append_user_to_team_with_http_info(user_id, user_team, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(user_team)
      ...
      new_options = opts.merge(
        :operation => :"UserApi.append_user_to_team",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
    ...
    def list_user_mods_with_http_info(user_id, opts = {})
      ...
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling UserApi.list_user_mods"
      end
      # resource path
      local_var_path = '/users/{user_id}/mods'.sub('{' + 'user_id' + '}', CGI.escape(user_id.to_s))
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<UserMod>'
    ...
    def list_user_packs_with_http_info(user_id, opts = {})
      ...
      # verify the required parameter 'user_id' is set
      if @api_client.config.client_side_validation && user_id.nil?
        fail ArgumentError, "Missing the required parameter 'user_id' when calling UserApi.list_user_packs"
      end
      # resource path
      local_var_path = '/users/{user_id}/packs'.sub('{' + 'user_id' + '}', CGI.escape(user_id.to_s))
