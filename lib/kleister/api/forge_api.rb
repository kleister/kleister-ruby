...
module Kleister
  class ForgeApi
    ...
    def append_forge_to_build_with_http_info(forge_id, forge_build, opts = {})
      ...
      # http body (model)
      post_body = opts[:debug_body] || @api_client.object_to_http_body(forge_build)
      ...
      new_options = opts.merge(
        :operation => :"ForgeApi.append_forge_to_build",
    ...
    def list_forges_with_http_info(opts = {})
      ...
      # return_type
      return_type = opts[:debug_return_type] || 'Array<Forge>'
    ...
    def search_forges_with_http_info(forge_id, opts = {})
      ...
      # resource path
      local_var_path = '/forge/{forge_id}'.sub('{' + 'forge_id' + '}', CGI.escape(forge_id.to_s))
      ...
      new_options = opts.merge(
        :operation => :"ForgeApi.search_forges",
        :header_params => header_params,
        :query_params => query_params,
        :form_params => form_params,
        :body => post_body,
